...
This mini-project focuses on the design and implementation of 

fuzzy systems for function approximation and mobile robot control.

# Core Concepts

- Fuzzy System Design: Designing a fuzzy Mamdani system using gradient descent for function approximation. The project also involves designing fuzzy systems with 

mean and maximum defuzzifiers.
